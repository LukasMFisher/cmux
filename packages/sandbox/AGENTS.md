...
After finishing, use the macOS `say` command (in the background with &) to notify the user with a short description of what to check/the next action the user should take (like a shell command/url/program they should interact with to veriy).
